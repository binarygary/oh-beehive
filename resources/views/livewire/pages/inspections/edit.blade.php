...
<div class="max-w-2xl space-y-6">
    ...
    @if(!empty($inspection->followup_questions))
        <div class="alert alert-info">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <div>
                <p class="font-semibold text-sm">AI Follow-up Questions</p>
                <ul class="list-disc list-inside text-sm mt-1 space-y-0.5">
                    @foreach($inspection->followup_questions as $q)
                        <li>{{ $q }}</li>
                    @endforeach
                </ul>
            </div>
        ...
        <div class="card bg-base-100 border border-base-300 shadow-sm">
            <div class="card-body p-5 space-y-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea wire:model="rawNotes" rows="5" class="textarea textarea-bordered w-full resize-y"></textarea>
